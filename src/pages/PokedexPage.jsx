...
const PokedexPage = () => {
  ...
  const handleChangeInput = (e) => {
    setLimitPokemon(parseInt(countPokemonPage.current.value));
  };
        ...
        <section className="section__form--pokedexpage">
          <form className="form--pokedexpage" onSubmit={handleSubmit}>
            <input
              ...
              ref={inputPoke}
              type="text"
              placeholder="Searh Pokémon"
            />
            <button className="btn--pokedexpage">Search</button>
          </form>
          <SelectPokeType setSelectInfo={setSelectInfo} />
          <select
            className="select__count--pokemones"
            ref={countPokemonPage}
            onChange={handleChangeInput}
          >
            <option value="">Count Pokemons</option>
